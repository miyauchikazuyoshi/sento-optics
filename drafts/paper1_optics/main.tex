...
than a specific probe, the same variable may also govern surface
tension ($\gamma \propto d\delta/dz$ at the liquid--vacuum boundary)
and electrical conductivity ($\sigma \propto \delta_\mathrm{charged}$),
offering a route toward a unified, quantum-statistical description of
interface-dominated material properties.
