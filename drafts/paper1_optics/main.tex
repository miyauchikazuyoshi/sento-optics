...
(correlation $= 0.66$ for C$_{60}$). A phenomenological
\emph{effective gloss} estimate based on the coherence preservation
factor is proposed, though we stress that this does not yet constitute
a quantitative gloss theory.
...
electrical conductivity. Exploring whether the same variable
can bridge optical response and thermodynamic interface properties
across different material classes is a natural next step.
