...
The literature-derived proxies (Table~\ref{tab:delta_proxies}) support
the existence of~$\delta$ but do not compute it directly. To close
this gap, we performed DFT (PBE) + Wannier90 calculations for bulk
diamond and graphite, obtaining the maximally localized Wannier function
(MLWF) spread~$\Omega$~\cite{Marzari1997}---which directly measures
the spatial extent of each electron in the solid.
