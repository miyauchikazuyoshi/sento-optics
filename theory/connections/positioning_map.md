...
| `memo_kohn_resta_swm_lineage.md` | Kohn–Resta–SWM 系譜の欠落と5つの気付き（脅威0: 金属Ω発散） | 2026-07-04 |
| `memo_nuclear_resta_phase.md` | 核版 Resta 位相による δ_nuc の静的再定義（提案） | 2026-07-04 |
| `memo_liquid_definition_gap_defense.md` | 「液体定義の空白」の防御可能な形 | 2026-07-04 |
| `memo_delocalization_as_primary_variable.md` | 非局在性を一次変数に置く理由（量子-古典連続化の根拠、4象限、同位体プローブ） | 2026-07-04 |

---

*統合版 2026-04-13。個別メモの思考の軌跡を1枚のマップに集約。*
*2026-04-13 追記: セクション8（量子-古典接続の最先端研究）を追加。*
*2026-07-04 追記: Kohn–Resta–SWM 系譜（memo_kohn_resta_swm_lineage.md）が§6の脅威一覧より大きい「脅威0（金属でのΩ発散）」を含むことが判明。§3.2 の三すくみ分析は memo_liquid_definition_gap_defense.md の在庫調べで裏付け。δ_nuc の静的再定義案は memo_nuclear_resta_phase.md。*
